...
CREATE TABLE IF NOT EXISTS employees (
    ...
    employee_code TEXT UNIQUE NOT NULL, -- For FA2000 device matching
    ...
    -- Employment Details
    employment_type TEXT NOT NULL CHECK(employment_type IN ('FULL_TIME', 'PART_TIME', 'TEACHING_STAFF', 'NON_TEACHING_STAFF')),
    ...
    -- Compensation
    base_rate DECIMAL(10, 2) NOT NULL, -- Hourly or daily rate
...
CREATE TABLE IF NOT EXISTS attendance_records (
    ...
    -- Time entries (can have multiple per day)
...
CREATE TABLE IF NOT EXISTS calendar_events (
    ...
    premium_rate DECIMAL(5, 2), -- e.g., 2.0 for double pay
    ...
    -- Protection
    is_system_event BOOLEAN DEFAULT 0, -- Cannot be deleted
...
CREATE TABLE IF NOT EXISTS deduction_types (
    ...
    is_statutory BOOLEAN DEFAULT 0, -- SSS, PhilHealth, Pag-IBIG, Tax
    is_active BOOLEAN DEFAULT 1,
    description TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS sss_contribution_table (
    ...
    effective_date DATE NOT NULL,
    msc_from DECIMAL(10, 2) NOT NULL, -- Monthly Salary Credit range start
    msc_to DECIMAL(10, 2) NOT NULL,   -- Monthly Salary Credit range end
    msc DECIMAL(10, 2) NOT NULL,      -- Actual MSC value
...
CREATE TABLE IF NOT EXISTS philhealth_contribution_table (
    ...
    employee_share DECIMAL(5, 4) NOT NULL, -- e.g., 0.025 for 2.5%
...
CREATE TABLE IF NOT EXISTS pagibig_contribution_table (
    ...
    employee_rate DECIMAL(5, 4) NOT NULL, -- e.g., 0.02 for 2%
    employer_rate DECIMAL(5, 4) NOT NULL,
    employee_max DECIMAL(10, 2), -- Maximum contribution cap
    is_active BOOLEAN DEFAULT 1
);
...
CREATE TABLE IF NOT EXISTS bir_tax_table (
    ...
    effective_date DATE NOT NULL,
    compensation_level TEXT NOT NULL, -- 'LEVEL_1', 'LEVEL_2', etc.
    annual_income_from DECIMAL(12, 2) NOT NULL,
    annual_income_to DECIMAL(12, 2),
    base_tax DECIMAL(12, 2) NOT NULL,
    tax_rate DECIMAL(5, 4) NOT NULL, -- Rate for income over threshold
...
CREATE TABLE IF NOT EXISTS pay_periods (
    ...
    is_locked BOOLEAN DEFAULT 0, -- Cannot modify once finalized
...
CREATE TABLE IF NOT EXISTS payroll_records (
    ...
    computation_details TEXT, -- JSON with step-by-step breakdown
...
-- Detailed allowances per payroll
...
-- Detailed deductions per payroll
...
('Teaching Load Bonus', 1, 'Additional teaching load compensation');
...
-- Philippine Holidays 2026 (Sample - F13)
